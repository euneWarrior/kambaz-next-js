...
export default function Lab1() {
  return (
    <div id="wd-lab1">
      <h2>Lab  1</h2>
      <h2>Created by Ryan Saadah, Link to Github at bottom of page</h2>
      <h3>HTML Examples</h3>
      <div id="wd-h-tag">
        <h4>Heading Tags</h4>
...
tag to tell browsers to render the gaps.
	...
	My favorite recipe: Green Bean Casserole
  	<ol id="wd-your-favorite-recipe">
    	  <li>Boil green beans until just tender.</li>
	  <li>Mix in cream of mushroom soup, milk, and seasonings.</li>
	  <li>Move to one quart baking dish.</li>
	  <li>Mix in fried onions.</li>
	  <li>Bake for 20 minutes and stir.</li>
	  <li>Top with additional fried onions.</li>
	  <li>Bake for 5 minutes.</li>
	  <li>Remove from oven and rest for 5 minutes.</li>
	  <li>Serve with a ladel and enjoy!</li>
  	</ol>
...
Morbi ullamcorper mollis augue sed accumsan. Morbi feugiat odio 
vitae tortor dignissim, quis pellentesque orci consectetur. 
Nullam id aliquam risus. Cras non lacus in elit placerat 
sagittis vel in elit. Integer hendrerit dolor vel nisl viverra, 
vitae consectetur urna aliquet. Lorem ipsum dolor sit amet, 
consectetur adipiscing elit. Quisque dapibus in orci sed convallis. 
Etiam at nunc dolor. Aliquam tincidunt nulla et erat pharetra 
imperdiet sit amet eget metus.
	  </textarea>
