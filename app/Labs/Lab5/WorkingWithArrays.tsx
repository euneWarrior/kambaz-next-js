...
<br /><br /><hr />
	...
	<FormCheck defaultValue={todo.completed ? "off" : "on"} className="w-25 float-start me-2"
        onChange={(e) => setTodo({ ...todo, completed: e.target.value == "yes" ? true : false })}/>
<br /><br /><hr />
	      <a href={`${API}/${todo.id}/description/${todo.title}`} className="btn btn-primary float-end">
